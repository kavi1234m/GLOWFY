...
#include "../GLOWFY/device_config.h"
...
#if (!WIN32)
#define DEBUG_LOG_SETTING_DEVELOP_MODE_EN		DEBUG_PRINT_ENABLE_DISABLE
#endif
...
#define VENDOR_MD_NORMAL_EN         	0//((!MI_API_ENABLE) || AIS_ENABLE)    // include ali
...
/********************** START NLC CONFIG ********************************/
#if !defined(LIGHT_TYPE_SEL)
#if NLC_TYPE == OCS_EN
    #define LIGHT_TYPE_SEL   LIGHT_TYPE_NLC_SENSOR
#elif NLC_TYPE == OCS_EN_AND_ALS_EN
  #define LIGHT_TYPE_SEL     LIGHT_TYPE_NLC_SENSOR
#elif NLC_TYPE == DIM_EN
  #define LIGHT_TYPE_SEL     LIGHT_TYPE_NLC_CTRL_CLIENT
...
#define MD_BATTERY_SERVER_EN        1
#define MD_BATTERY_CLIENT_EN        0
#define MD_BATTERY_SERVER_EN        1
#define MD_BATTERY_CLIENT_EN        0
...
#define FEATURE_FRIEND_EN		0
	#else
#define FEATURE_FRIEND_EN 		0   // WIN 32 should be support disable: model_sig_cfg_s.frid
	#endif
#define FEATURE_LOWPOWER_EN		0
#define FEATURE_PROV_EN 		1
