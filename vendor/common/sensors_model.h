...
#if (NLC_SENSOR_TYPE_SEL == NLCP_TYPE_ALS)
#define SENSOR_SETTING_PROP_ID1			PROP_ID_PRESENCE_DETECTED//PROP_ID_SENSOR_GAIN
#endif
...
#if MD_BATTERY_EN
#if MD_BATTERY_SERVER_EN
	model_g_light_s_t battery_srv[LIGHT_CNT];
#else
	model_client_common_t battery_clnt[1];
#endif
#endif
//#if BATTERY_SERVER_LOCATE_EXCLUSIVE_ELEMENT_EN
//	model_g_light_s_t battery_srv[LIGHT_CNT];
//#endif
}model_sensor_t;
