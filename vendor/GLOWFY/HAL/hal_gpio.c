...
{
	gpio_write(GPIO_PD6,level); // gpio_read
}

/******************************************************************************
 * @brief     This function read the button_pin1 input/output level.
...
/******************************************************************************
 * @brief     This function read the button_pin2 input/output level.
 * @param[in] pin - the pin needs to read its level
 * @return    the pin's level(1: high 0: low)
 ******************************************************************************/
uint8_t button_pin2_read(void)
{
	return BM_IS_CLR(reg_gpio_in(GPIO_PD5), GPIO_PD5 & 0xff);
}
/******************************************************************************
