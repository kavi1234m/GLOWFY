 ...
 * @note
 ******************************************************************************/
//void get_battery_volt(u8 loop)
//{
//	u16 battery_volt=app_battery_power_check_and_sleep_handle(loop);
//	send_battery_status(battery_volt);
//}
void fetch_battery_volt_and_send_status(void)
{
