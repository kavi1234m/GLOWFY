...
#else
#define ADV_INTERVAL_MS			(ADV_INTERVAL_10MS)   // with random (0~30ms)
#endif
...
#endif
#define FRI_ESTABLISH_PERIOD_MS     (FRI_ESTABLISH_REC_DELAY_MS + FRI_ESTABLISH_WIN_MS)  //(100+1000)-1.1 sec
...
//#define LPN_POLL_TIMEOUT_100MS      (250*10) // unit: 100ms, 0x0A~0x34BBFF
//#define FRI_POLL_INTERVAL_MS        (40000)	// auto send poll interval
...
//#define LPN_SCAN_PROVISION_START_TIMEOUT_MS (30*1000)   // from power up to this time, if didn't receive provision start command, LPN will auto enter sleep.
//#define LPN_WORKING_TIMEOUT_MS   	        (30*1000)   // Prevent abnormal working time.
//#define LPN_START_REQUEST_AFTER_BIND_MS     (GATT_LPN_EN ? (10*1000) : (10*1000))    //

/**********lpn config by user*********/
#define LPN_POLL_TIMEOUT_100MS                    (POLL_TIMEOUT*2*10)
#define FRI_POLL_INTERVAL_MS                      (POLL_TIMEOUT*1000)
#define LPN_SCAN_PROVISION_START_TIMEOUT_MS       (PROVISION_TIME*1000)
#define LPN_WORKING_TIMEOUT_MS                    (PROVISION_TIME*1000)
#define LPN_START_REQUEST_AFTER_BIND_MS           (KEY_BIND_TIME*1000)
#define LPN_REQ_SEND_COMMAND_COUNT                (2)
